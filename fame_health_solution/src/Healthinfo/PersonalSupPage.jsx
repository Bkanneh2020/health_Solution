  ...
  return (
    <div id="personalsupread" style={personalstyle}>
      <div style={{ backgroundColor: "#020b11" }}>
        <h3 className="divheading">Personal Support</h3>
      </div>
      <div className="homemaker101">
        <div>
          <img
            src={"/Images/coffeetime.jpg"}
        ...
        <div>
          <p className="divparagraph">
            ...
            proin nibh nisl condimentum id venenatis a. Lorem ipsum dolor sit
            amet. Interdum velit laoreet id donec ultrices. Imperdiet nulla
            malesuada pellentesque elit eget gravida cum sociis. Sagittis purus
            sit amet volutpat consequat mauris. Cras fermentum odio eu feugiat
            pretium. Dictumst vestibulum rhoncus est pellentesque elit
            ullamcorper. Eget mauris pharetra et ultrices neque ornare aenean.
